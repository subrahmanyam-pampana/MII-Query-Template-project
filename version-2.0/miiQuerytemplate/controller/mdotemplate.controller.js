  ...
  function (
    ...
    return Controller.extend("app.controller.mdotemplate", {
      onInit: function () {
        ...
        var parameterData = [
          { parameter: "Param.1", value: "", datatype: "String" },
          { parameter: "Param.2", value: "", datatype: "String" },
          { parameter: "Param.3", value: "", datatype: "String" },
          { parameter: "Param.4", value: "", datatype: "String" },
          { parameter: "Param.5", value: "", datatype: "String" },
          { parameter: "Param.6", value: "", datatype: "String" },
          { parameter: "Param.7", value: "", datatype: "String" },
          { parameter: "Param.8", value: "", datatype: "String" },
          { parameter: "Param.9", value: "", datatype: "String" },
          { parameter: "Param.10", value: "", datatype: "String" },
          { parameter: "Param.11", value: "", datatype: "String" },
          { parameter: "Param.12", value: "", datatype: "String" },
          { parameter: "Param.13", value: "", datatype: "String" },
          { parameter: "Param.14", value: "", datatype: "String" },
          { parameter: "Param.15", value: "", datatype: "String" },
        ];
      ...
      onServerSelectionChange: function (oEvent) {
        ...
        try {
          $.ajax({
            url: `${serversList.servers[0].url}/XMII/Runner?Transaction=${mdoQT.transactions.getFileListTransaction}&OutputParameter=*&Content-Type=text/xml&${credentialsString}`,
            method: "GET",
            data: {
      ...
      onProjectSelectionChange: function (oEvent) {
        ...
        try {
          $.ajax({
            url: `${serversList.servers[0].url}/XMII/Runner?Transaction=${mdoQT.transactions.getMDOList}&OutputParameter=*&Content-Type=text/json&${credentialsString}`,
            method: "GET",
            data: {
      ...
      onMDOSelectChange: function (oEvent) {
       ...
       // let selecetedItem = oEvent.getParameters("item").item;
        ...
        try {
          $.ajax({
            url: `${serversList.servers[0].url}/XMII/Runner?Transaction=${mdoQT.transactions.MDOTransaction}&OutputParameter=*&Content-Type=text/json&${credentialsString}`,
            data: {
              MDO: mdoPath,
      ...
      executeQuery: function () {
        ...
        paramModel.forEach((param, idx) => {
          if (param.value != "") {
            ...
            if (oviews.typedParamsCheckBox.getSelected()) {
              var paramIdx = idx + 1;
